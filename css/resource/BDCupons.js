function countDown(x) {
    if (x.matches) {
        ...
        var x = setInterval(function () {
            ...
            if (distance < 0) {
                clearInterval(x);
                document.getElementById('PC').innerHTML = 'EXPIRED';
            }
        }, 1000);
    }
}
...
function updateCountdown() {
    ...
    if (timeDifference <= 0) {
        ...
        document.getElementById('PC').innerHTML = "It's already tomorrow!";
    } else {
        ...
        // Display the result
        document.getElementById('PC').innerHTML = countdownText;
    }
}
